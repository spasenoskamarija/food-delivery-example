...
public class DishApplicationServiceImpl implements DishApplicationService {
    ...
    public DisplayDishDto save(CreateDishDto createDishDto) {
        Restaurant restaurant = restaurantService.findById(createDishDto.restaurantId()).orElseThrow(() -> new RestaurantNotFoundException(createDishDto.restaurantId()));
    ...
    public DisplayOrderDto addToOrder(Long id, String username) {
        ...
        Order order = orderService.findOrCreatePending(user.getUsername());
